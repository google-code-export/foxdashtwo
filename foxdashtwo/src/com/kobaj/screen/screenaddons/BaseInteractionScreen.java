...
public class BaseInteractionScreen
{
	...
	public void onUpdate(double delta, GameInputModifier my_modifier, Level test_level)
	{
		...
		double buffer = (float) Functions.linearInterpolate(0, Constants.max_speed, Functions.speed(test_level.player.quad_object.x_vel, test_level.player.quad_object.y_vel), Constants.min_zoom, Constants.max_zoom);
