package com.kobaj.math.android;

// why is this here?
// because the unit framework Robolectric doesnt support native android.graphics.RectF
// but we can get the unit testor to work if we write our own RectF, aka, copy the source file.
// Ideally when unit testing is done, we can revert back to the native android.graphics.RectF
