...
public class LevelObject extends LevelEntityActive
{
	...
	public void onInitialize()
	{
		...
		else if (this_object == EnumLevelObject.l2_ground_platform_floating)
		{
			quad_object = new QuadCompressed(R.raw.l2_ground_platform_floating, R.raw.l2_ground_platform_floating_alpha, 391, 198);
